...
def riempi_griglia(griglia):
    ...
    griglia_lista = griglia.tolist()
    sudoku_collection.insert_one({'stato': 'soluzione', 'griglia' : griglia_lista})
    return True  
...
def rimozione_numeri_griglia(griglia, numero_rimozioni):
    ...
    griglia_modificata = griglia.copy()
...
if(__name__ == "__main__"):
    ...
    griglia_modificata = rimozione_numeri_griglia(griglia, 56)
